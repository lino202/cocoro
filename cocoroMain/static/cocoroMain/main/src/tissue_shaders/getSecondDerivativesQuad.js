...
export function getSecondDerivativesQuad(nNodes){
    ...
    return /*wgsl*/`
        ...
        if ( (_i_j1 < ${nNodes}) & (_i1_j1 < ${nNodes}) & (_i1_j < ${nNodes}) & (_i1_1j < ${nNodes}) & (_i_1j < ${nNodes}) & (_1i_1j < ${nNodes}) & (_1i_j < ${nNodes}) & (_1i_j1 < ${nNodes}) ) {
            ...
            // ATTENTION Holes of 1 square width in x or y are not allowed, as well as nodes representing regions with zero volumen as two squares in diagonal. 
            // The code will not realize we have a hole of 1 quad or a point of 0 volume, it will just calculate the derivatives as if the square was there.
            ${wgsl_quad_d2dxdx_V}
            ${wgsl_quad_d2dydy_V}
            ${wgsl_quad_d2dxdy_V}
        }
