...
export const SimLineMonodomainNoDataRace = async (gui:GUI, meshData:meshObj, electrodesData:electrodesObj, cellObj:cellObj, ensightWriter:EnsightWriter|undefined, guiCellVarGraph:GUI, guiPECGGraph:GUI) => {
    ...
    const voiBuffer    = createGPUBuffer(device, vmArray, GPUBufferUsage.VERTEX | GPUBufferUsage.STORAGE);
