...
export const SimHexaMonodomain = async (gui:GUI, meshData:meshObj, electrodesData:electrodesObj, cellObj:cellObj, li:LightInputsInterface, ensightWriter:EnsightWriter|undefined) => {
